...
public sealed class ACME_P_SignIn : OpenSpan.Automation.Automator
{
	...
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8D8E55BD1146088\\EntryPoint-8D8E55BDC062F9F")]
	...
	public ACME_P_SignIn()
	{
		...
		// 
		this.Id = new OpenSpan.Design.ComponentIdentity("Automator-8D8E55BD1146088");
		// 
		// Set component Ids
		// 
		this.SetId(this.entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D8E55BDC062F9F"));
		this.SetId(this.labelHost1, new OpenSpan.Design.ComponentIdentity("LabelHost-8D8E55BDFDAF6F7"));
		this.SetId(this.labelHost2, new OpenSpan.Design.ComponentIdentity("LabelHost-8D8E55BE7C21098"));
		this.SetId(this.exitPoint1, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D8E55BF79783F7"));
		this.SetId(this.exitPoint2, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D8E55C07DAE163"));
		this.SetId(this.connectableProperties1, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D8E55C2670827A"));
		this.SetId(this.connectableProperties2, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D8E55C305822D4"));
		this.SetId(this.connectableProperties3, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D8E55C3E8173D9"));
		this.SetId(this.connectableMethod1, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D8E55C6276E73E"));
		...
		this.entryPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D8E55BD1146088\\EntryPoint-8D8E55BDC062F9F");
		...
		dynamicmethodinfo2.CodeDomData = _resources_.GetString("_ACME_P_SignIn_5_");
		...
		dynamicmethodinfo3.CodeDomData = _resources_.GetString("_ACME_P_SignIn_6_");
		...
		dynamicpropertyinfo3.CodeDomData = _resources_.GetString("_ACME_P_SignIn_7_");
		...
		dynamicpropertyinfo4.CodeDomData = _resources_.GetString("_ACME_P_SignIn_8_");
		...
		dynamicpropertyinfo5.CodeDomData = _resources_.GetString("_ACME_P_SignIn_9_");
		...
		this.exitPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D8E55BD1146088\\EntryPoint-8D8E55BDC062F9F");
		// 
		// exitPoint2
		// 
		...
		dynamicpropertyinfo6.CodeDomData = _resources_.GetString("_ACME_P_SignIn_8_");
		...
		this.exitPoint2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D8E55BD1146088\\EntryPoint-8D8E55BDC062F9F");
		// 
		...
		this.connectableProperties1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8D8DE50B28552EF\\TextBox-8D8E248B7E2F760");
		...
		this.connectableProperties2.InstanceTypeName = "OpenSpan.Adapters.Web.WebBase.Controls.TextBox";
		this.connectableProperties2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8D8DE50B28552EF\\TextBox-8D8E248A5BC358E");
		...
		// 
		this.connectableProperties3.DefaultValues = "Text=1234\r\n";
		this.connectableProperties3.DisplayName = "Properties";
		this.connectableProperties3.ExceptionsHandled = false;
		this.connectableProperties3.InstanceTypeName = "OpenSpan.Adapters.Web.WebBase.Controls.TextBox";
		this.connectableProperties3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8D8DE50B28552EF\\TextBox-8D8E248B7E2F760");
		...
		this.connectableMethod1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8D8DE50B28552EF\\Button-8D8E248BC54D22E");
		...
		this.jumpHost1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D8E55BD1146088\\LabelHost-8D8E55BDFDAF6F7");
		...
		this.jumpHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D8E55BD1146088\\LabelHost-8D8E55BE7C21098");
		...
		parameterprototype1.DefaultValue = "ACME Home is not available\r\n";
		...
		this.jumpHost3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D8E55BD1146088\\LabelHost-8D8E55BE7C21098");
		...
		memberprototype7.Signature.ParameterPrototype.Add(parameterprototype2);
	...
	internal OpenSpan.Automation.EntryPoint Create_entryPoint1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D8E55BDC062F9F"));
	...
	internal OpenSpan.Automation.LabelHost Create_labelHost1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(labelHost1, new OpenSpan.Design.ComponentIdentity("LabelHost-8D8E55BDFDAF6F7"));
		labelHost1.DisplayName = "Sucess";
		OpenSpan.DynamicMembers.DynamicMethodInfo dynamicmethodinfo1 = new OpenSpan.DynamicMembers.DynamicMethodInfo();
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_ACME_P_SignIn_5_");
	...
	internal OpenSpan.Automation.LabelHost Create_labelHost2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(labelHost2, new OpenSpan.Design.ComponentIdentity("LabelHost-8D8E55BE7C21098"));
		labelHost2.DisplayName = "Failed";
		OpenSpan.DynamicMembers.DynamicMethodInfo dynamicmethodinfo1 = new OpenSpan.DynamicMembers.DynamicMethodInfo();
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_ACME_P_SignIn_6_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo1 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo1.IsSerializable = true;
		dynamicpropertyinfo1.NoInputConvesion = false;
		dynamicpropertyinfo1.Source = "";
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_ACME_P_SignIn_7_");
	...
	internal OpenSpan.Automation.ExitPoint Create_exitPoint1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(exitPoint1, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D8E55BF79783F7"));
		...
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_ACME_P_SignIn_8_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo2 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo2.IsSerializable = true;
		dynamicpropertyinfo2.NoInputConvesion = false;
		dynamicpropertyinfo2.Source = "";
		dynamicpropertyinfo2.ValidateConnectionCallback = null;
		dynamicpropertyinfo2.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo2.CodeDomData = _resources_.GetString("_ACME_P_SignIn_9_");
		...
		exitPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D8E55BD1146088\\EntryPoint-8D8E55BDC062F9F");
		// 
		// Set designComp Ids
		// 
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D8E55BDC062F9F"));
	...
	internal OpenSpan.Automation.ExitPoint Create_exitPoint2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(exitPoint2, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D8E55C07DAE163"));
		...
		exitPoint2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D8E55BD1146088\\EntryPoint-8D8E55BDC062F9F");
		// 
		// Set designComp Ids
		// 
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D8E55BDC062F9F"));
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties1, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D8E55C2670827A"));
		connectableProperties1.DefaultValues = "";
		connectableProperties1.DisplayName = "Properties";
		connectableProperties1.ExceptionsHandled = false;
		connectableProperties1.InstanceTypeName = "OpenSpan.Adapters.Web.WebBase.Controls.TextBox";
		connectableProperties1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8D8DE50B28552EF\\TextBox-8D8E248B7E2F760");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "IsCreated";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Property;
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties2, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D8E55C305822D4"));
		connectableProperties2.DefaultValues = "Text=1234";
		connectableProperties2.DisplayName = "Properties";
		connectableProperties2.ExceptionsHandled = false;
		connectableProperties2.InstanceTypeName = "OpenSpan.Adapters.Web.WebBase.Controls.TextBox";
		connectableProperties2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8D8DE50B28552EF\\TextBox-8D8E248A5BC358E");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties3(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties3, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D8E55C3E8173D9"));
		connectableProperties3.DefaultValues = "Text=1234\r\n";
		connectableProperties3.DisplayName = "Properties";
		connectableProperties3.ExceptionsHandled = false;
		connectableProperties3.InstanceTypeName = "OpenSpan.Adapters.Web.WebBase.Controls.TextBox";
		connectableProperties3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8D8DE50B28552EF\\TextBox-8D8E248B7E2F760");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Text";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Property;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod1, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D8E55C6276E73E"));
		...
		connectableMethod1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8D8DE50B28552EF\\Button-8D8E248BC54D22E");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost1, new OpenSpan.Design.ComponentIdentity("JumpHost-8D8E55C740E4E6A"));
		jumpHost1.DisplayName = "<GoToLabel>";
		jumpHost1.ExceptionsHandled = false;
		jumpHost1.InstanceTypeName = "OpenSpan.Automation.LabelHost";
		jumpHost1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D8E55BD1146088\\LabelHost-8D8E55BDFDAF6F7");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost2, new OpenSpan.Design.ComponentIdentity("JumpHost-8D8E55C7C0E4DC3"));
		jumpHost2.DisplayName = "<GoToLabel>";
		jumpHost2.ExceptionsHandled = false;
		jumpHost2.InstanceTypeName = "OpenSpan.Automation.LabelHost";
		jumpHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D8E55BD1146088\\LabelHost-8D8E55BE7C21098");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GoToLabel";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost3(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost3, new OpenSpan.Design.ComponentIdentity("JumpHost-8D8E55C921362E7"));
		jumpHost3.DisplayName = "<GoToLabel>";
		jumpHost3.ExceptionsHandled = false;
		jumpHost3.InstanceTypeName = "OpenSpan.Automation.LabelHost";
		jumpHost3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D8E55BD1146088\\LabelHost-8D8E55BE7C21098");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GoToLabel";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
